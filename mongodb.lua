mongodb_protocol = Proto("MongoDB",  "MongoDB Protocol2")
...
function get_opcode_name(opcode)
  ...
  elseif opcode == 2011 then opcode_name = "OP_COMMANDREPLY"
  elseif opcode == 2013 then opcode_name = "OP_MSG" end

  return opcode_name
end

local tcp_port = DissectorTable.get("tcp.port")
tcp_port:add(27017, mongodb_protocol)
